  ...
  return (
    ...
    >
      <div className="custom-container mx-auto my-30">
        ...
        <div className="mt-14 grid grid-cols-1 gap-x-12 gap-y-8 lg:grid-cols-2 xxl:grid-cols-3 xxl:gap-y-0">
          <motion.div
            initial={
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="flex flex-col justify-between overflow-hidden rounded-3xl bg-gradient-to-b from-pink-special-1 to-green-special-3 px-9 pt-9 text-white"
          >
            <div>
          ...
          <div className="flex flex-col justify-between space-y-4 pt-11">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="flex flex-col justify-between space-x-2 rounded-3xl bg-gradient-to-r from-green-special-4 to-green-special-5 py-8 pr-4 sm:flex-row"
            >
              <img
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="flex flex-col justify-between overflow-hidden rounded-3xl bg-gradient-to-r from-red-special to-red-special-1 px-2 py-12 pr-4 sm:flex-row sm:pl-7"
            >
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="col-span-1 mt-72 flex flex-col justify-end lg:col-span-2 lg:mt-64 xxl:col-span-1 xxl:mt-0"
          >
